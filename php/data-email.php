...
//$email = trim(strip_tags($_POST['f']['email'])); //Лучше записать даннные в переменные именно таким образом
//$name = trim(strip_tags($_POST['f']['name']));   // Уберет html/php код и удалит лишние обрамляющие текст пробелы обеспечать тем самым небольшую защиту
