...
//
// Это старая и первая версия обработчика для отправки данных на почту
// Оставленна т.к. было потрачено много сил на её создание
// Предстваляет собой большую ценность для разработчика т.к. является бесценным опытом ;)
//
